...
\multirow{3}{*}{Skenēšanas modulis}
    & Literālo vērtību parsēšana & LEX-1 \\
\cmidrule(lr){2-3}
    & Burtciparu ne-virkņu vērtību novērtēšana  & LEX-2 \\
\cmidrule(lr){2-3}
    & Rakstzīmju pārveidošana uz leksēmu zīmogiem & LEX-3 \\
...
\begin{tabularx}{\textwidth}{ 
    >{\raggedright\arraybackslash}c  % Error Identifier
...
\bottomrule
\end{tabularx}
\caption{List of errors with descriptions}
\end{table}
