...
impure" jeb tulkojumā no angļu valodas "netīrs" apzīmē funkcijas, kas maina ārējos stāvokļus vai ir atkarīgas no tiem. Savukārt "pure" jeb "tīras" funkcijas ir tādas, kas neietekmē ārējos stāvokļus un ir atkarīgas tikai no to parametriem. Tīru funkciju izmantošana pirmkodā ir ieteicama, jo tā padara programmu prognozējamāku un vieglāk saprotamu, jo zināms ka tīras funkcijas var izsaukt tikai citas tīras funkcijas vai izteiksmes, kas nozīmē, ka tās nevienā brīdī neizmaina ārējo stāvokli. Tātad, \texttt{pure} atslēgvārds tiek lietots, lai definētu tīru funkciju, bet \texttt{impure} - netīru. Ja funkcija ir definēta kā tīra, tad tās argumentu sarakstā nav atļauts norādīt mutablus mainīgos un tās ķermenī izsaukt netīras funkcijas. Savukārt netīra funkcija nepieņem nemutablus mainīgos un funkcijas ķermenī atļauj izsaukt gan tīras, gan netīras funkcijas. Atslēgvārda \texttt{pure} lietošana nav obligāta, jo valodā Immutant pēc noklusējuma lietotāja definētās funkcijas tiek uzskatītas par tīrām. 
...
\begin{itemize}
  ...
  \item \texttt{RUNTIME\_ERR-9}
  \item \texttt{RUNTIME\_ERR-10}
...
\begin{itemize}
  \item \texttt{print(value)} - tīra funkcija - izvada dotā operanda vērtību uz konsoli. pieņem jebkura datu tipa vērtību kā argumentu, un izvada tās reprezentāciju kā virkni uz konsoli.
  \item \texttt{time()} - tīra funkcija - izvada pašreizējo laiku milisekundēs kopš 1970. gada 1. janvāra 00:00:00 UTC.
  \item \texttt{toString(value), toNumber(value), toBoolean(value), typeOf(value)} - tīras datu tipu konversijas funkcijas, kas aprakstītas sadaļā ~\ref{section:datatype-conversion}
...
\midrule
RUNTIME\_ERR-9 & Ja netīras funkcijas izsaukumā tiek padots arguments, kas ir nemutabls mainīgais, parāda paziņojumu: ``Cannot pass immutable argument to impure function``.                                                                                  \\
\midrule
RUNTIME\_ERR-10 & Ja tīras funkcijas izsaukumā tiek padots arguments, kas ir mutabls mainīgais, parāda paziņojumu: ``Cannot pass mutable argument to pure function``.  \\
\midrule
