...
Tās var saturēt jebkādus simbolus, tostarp spec-simbolus, kā \texttt{@,\^\space,\&} u.c. Proti, virknēs nav liegts izmantot speciālos atslēgas vārdus, ko pati valoda ir definējusi, piemēram, \texttt{mutant} (vairāk par to minēts sadaļā ~\ref{section:vars}).
