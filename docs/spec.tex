...
\begin{verbatim}
"They call themselves \"the wolves\""k
\end{verbatim}
...
Nemutablus mainīgos nedrīkst re-inicializēt, tas nozīmē, ka sekojoša programma izmetīs kļūdu \texttt{ImmutableVariableModificationException}:
\begin{verbatim}
imut x = 10;
