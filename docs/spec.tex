...
\begin{figure}[h]   
    ...
    \vspace{0.5cm}  
    \caption{Funkcijas CLI-2 projektējums}
    \label{fig:fun_cli_2}                  
\end{figure}

\subsection{CORE-1 funkcijas projektējums: Interpretēšanas piespiedu apstādināšana}


\subsection{LEX-1 funkcijas projektējums: Rakstzīmju pārveidošana uz leksēmu zīmogiem}

\subsection{LEX-2 funkcijas projektējums: Burtciparu ne-virkņu vērtību skenēšana}

\subsection{LEX-3 funkcijas projektējums: Literālo vērtību skenēšana}
...
\subsection{EVAL-2 funkcijas projektējums: Izteiksmes AST izvērtēšana}

\subsection{EVAL-3 funkcijas projektējums: Priekšraksta AST izvērtēšana}
