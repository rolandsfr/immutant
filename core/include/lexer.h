...
enum TokenType {
    ...
    TOKEN_PLUS, TOKEN_MINUS, TOKEN_STAR, TOKEN_SLASH, TOKEN_SEMICOLON, TOKEN_DOT,
    ...
    // Keywords
    TOKEN_FALSE, TOKEN_TRUE, TOKEN_NIL, TOKEN_WHILE, TOKEN_IF, TOKEN_ELSE,
    TOKEN_IMMUTANT, TOKEN_MUTANT, TOKEN_FN, TOKEN_RETURN,
